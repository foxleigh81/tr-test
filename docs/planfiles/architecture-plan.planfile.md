...
Note: For this application, only `data-display` is being used, I've inclduded the others in the plan for a demonstration of how I'd architect the project for scale.
